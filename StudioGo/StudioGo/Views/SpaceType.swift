...
class SpaceType: UIView {
    ...
    func createView() -> UIView {
        ...
        imageView.image = UIImage(named: "SpaceType")
    ...
    @objc func popController() {
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "popSpaceTypeController"), object: nil)
    }
    /*
